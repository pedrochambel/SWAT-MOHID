...
Module ModuleGlobalData
    ...
    !Parameter-----------------------------------------------------------------
    integer, parameter  :: MaxModules           =  73
...
!________________________________________________________________________________________________________________________   
    ...
    !Vegetation Root Profiles
    integer, parameter                          :: RootLinear_              = 1
    integer, parameter                          :: RootTriangular_          = 2

    !Evaporation / Transpiration Methods
    ...
    type (T_Module), dimension(MaxModules), parameter  :: MohidModules =  (/             &
          ...
          T_Module(mPOROUSMEDIAPROPERTIES_ ,  "PorousMediaProperties") /)
