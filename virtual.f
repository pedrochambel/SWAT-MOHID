...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
	...
	!PCL start
      HRU_output_values0(1) = subp(j)
      HRU_output_values0(2) = snofall
      HRU_output_values0(3) = snomlt
      HRU_output_values0(4) = aird(j)
      HRU_output_values0(5) = pet_day
      HRU_output_values0(6) = etday
      HRU_output_values0(7) = sol_cnsw(j)
      HRU_output_values0(8) = sol_sw(j)
      HRU_output_values0(9) = sepbtm(j)
      HRU_output_values0(10) = rchrg(j)
      HRU_output_values0(11) = gwseep
      HRU_output_values0(12) = revapday
      HRU_output_values0(13) = shallirr(j)
      HRU_output_values0(14) = deepirr(j)
      HRU_output_values0(15) = shallst(j)
      HRU_output_values0(16) = deepst(j)
      HRU_output_values0(17) = surfq(j)
      HRU_output_values0(18) = qday + tloss
      HRU_output_values0(19) = tloss
      HRU_output_values0(20) = latq(j)
      HRU_output_values0(21) = gw_q(j)
      HRU_output_values0(22) = qdr(j)
      HRU_output_values0(23) = cnday(j)
      HRU_output_values0(24) = tmpav(j)
      HRU_output_values0(25) = tmx(j)
      HRU_output_values0(26) = tmn(j)
      HRU_output_values0(27) = sol_tmp(2,j)
      HRU_output_values0(28) = hru_ra(j)
      HRU_output_values0(29) = sedyld(j) / hru_ha(j)
      HRU_output_values0(30) = usle
      HRU_output_values0(31) = fertn
      HRU_output_values0(32) = fertp
      HRU_output_values0(33) = auton
      HRU_output_values0(34) = autop
      HRU_output_values0(35) = grazn
      HRU_output_values0(36) = grazp
      HRU_output_values0(37) = cfertn
      HRU_output_values0(38) = cfertp
      HRU_output_values0(39) = no3pcp
      HRU_output_values0(40) = fixn
      HRU_output_values0(41) = rmn2tl
      HRU_output_values0(42) = hmntl
      HRU_output_values0(43) = rwntl
      HRU_output_values0(44) = rmptl
      HRU_output_values0(45) = hmptl
      HRU_output_values0(46) = rmp1tl
      HRU_output_values0(47) = roctl
      HRU_output_values0(48) = wdntl
      HRU_output_values0(49) = nplnt(j)
      HRU_output_values0(50) = pplnt(j)
      HRU_output_values0(51) = sedorgn(j)
      HRU_output_values0(52) = sedorgp(j)
      HRU_output_values0(53) = sedminpa(j) + sedminps(j)
      HRU_output_values0(54) = surqno3(j)
      HRU_output_values0(55) = latno3(j)
      HRU_output_values0(56) = percn(j)
      HRU_output_values0(57) = no3gw(j)
      HRU_output_values0(58) = surqsolp(j)
      HRU_output_values0(59) = minpgw(j)
      HRU_output_values0(60) = (1.-strsw(j))
      HRU_output_values0(61) = (1.-strstmp(j))
      HRU_output_values0(62) = (1.-strsn(j))
      HRU_output_values0(63) = (1.-strsp(j))
      HRU_output_values0(64) = bio_ms(j)
      HRU_output_values0(65) = laiday(j)
      HRU_output_values0(66) = 0.0       !!yield only defined at annual and average annual
      HRU_output_values0(67) = bactrop + bactsedp
      HRU_output_values0(68) = bactrolp + bactsedlp
...
!! sum HRU results for subbasin 
     ...
     &          + (hhsedy(j,ii) + ubntss(ii)) * hru_fr(j)
      ...
      !! subbasin averages: nutrients
		...
		TON = sol_orgn(1,j) + sol_aorgn(1,j) + sol_fon(1,j)      !PCL
        sub_yorgnDON(sb) = sub_yorgnDON(sb) + sedorgn (j) *            !PCL
     &               (sol_aorgn(1,j) / TON) * hru_fr(j)                !PCL
        sub_yorgnPON(sb) = sub_yorgnPON(sb) + sedorgn (j) *            !PCL
     &               ((sol_orgn(1,j)+ sol_fon(1,j)) / TON) * hru_fr(j) !PCL        
