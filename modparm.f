      module parm
      integer icalen
      integer :: MainObjSwatID !PCL
	logical :: SwatWithChanges !PCL
	real,			dimension(:,:,:),pointer  :: OutputHruMeteo     !PCL
	real,			dimension(:,:,:),pointer  :: OutputHruWatBal    !PCL
      real,			dimension(:,:,:),pointer  :: OutputHruQuality   !PCL
      real,			dimension(:,:,:),pointer  :: OutputHruParameters!PCL
      real,			dimension(:,:),  pointer  :: OutputSubBasin     !PCL
      real,			dimension(:,:),  pointer  :: OutputSubBasin2    !PCL
      real,			dimension(:,:),  pointer  :: OutputReaches      !PCL
      real,			dimension(:),    pointer  :: OutputGlobalBasin  !PCL
	character(len=4),dimension(:,:), pointer  :: OutputHRU_Cropname !PCL
	real,			dimension(:),    pointer  :: HRU_output_values0 !PCL
	real,			dimension(:,:,:),pointer  :: HRU_output_values  !PCL
	real    :: Get_rvol,Get_rnit !PCL
	integer :: MaxHruInSubBasin !PCL
	real    :: DenitrificationThreshold !PCL
	real    :: LateralFlowTravelTime !PCL
...
!      real, dimension (:), allocatable :: rcn_org_sub               !PCL      
      ...
      real, dimension (:), allocatable :: sub_yorgnDON,sub_yorgnPON !PCL      
